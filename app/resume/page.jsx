...
import {
  SiTailwindcss, SiNextdotjs, SiPrisma
} from 'react-icons/si'
...
const about = {
  ...
  info:[
    { fieldName: 'Name', fieldValue: 'Konstantin Ivanovic' },
    { fieldName: 'Phone', fieldValue: '(+1)236 867 9118' },
    { fieldName: 'Experience', fieldValue: '2 Years' },
    { fieldName: 'Email', fieldValue: 'konstantin.dev8@gmail.com' },
    { fieldName: 'Freelance', fieldValue: 'Available' },
    { fieldName: 'Languages', fieldValue: 'English, Montengrin' },
  ]
}
...
const experience = {
  ...
  items: [
    { company: 'Stadion DOO Distribution', position: 'Full Stack Developer', duration: '2021-2022 and remote from 2023 to present.' },
    { company: 'Telekom T-Mobile', position: 'Full Stack Developer and IT sector', duration: '2020-2021' },
    { company: 'E-Commerce Startup', position: 'Freelance Web Developer', duration: '2018-2021' }
  ]
}
...
const education = {
  ...
  items: [
    { institution: 'Faculty of Science - University of Montenegro', position: 'Full Stack Software Engineer', duration: '2017-2021' },
    { institution: 'Cornerstone Community College of Canada', position: 'Web Developer Diploma', duration: '2022-2023' },
    { institution: 'Codecademy - Online coding', position: 'Front End Development', duration: '2023' },
    { institution: 'AWS Cloud Services', position: 'AWS Certified Cloud Practitioner', duration: '2025' },
  ]
}
                ...
                >
                  ...
                  <ul className='grid grid-cols-1 xl:grid-cols-2 gap-y-10 gap-x-8 max-w-[620px] mx-auto xl:mx-0'>
                    {about.info.map((item, index)=>(
                      <li key={index} className='flex items-center justify-center xl:justify-start gap-8'>
